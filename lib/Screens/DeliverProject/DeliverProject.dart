...
class DeliverProject extends StatefulWidget {
   DeliverProject({required this.deadline,required this.id,required this.title,required this.jd,super.key});
  String id;
  String title;
  String jd;
  String deadline;
...
class _DeliverProjectState extends State<DeliverProject> {
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: _DeliverProjectState.selected?Text("File Uploaded"): Text("File Not Selected"),
                          ),
                        ),
                        Padding(
  ...
  void deliverr() async{
    ...
    final json=jsonEncode({
      "deliverylink":_DeliverProjectState.link
    });
     var res = await http.post(Uri.parse(api+"projects/submit/${widget.id}" ),body: json,headers: headers);var result = jsonDecode(res.body);print(result);
