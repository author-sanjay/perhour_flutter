                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Container(height: MediaQuery.of(context).size.height*0.04,child: TextFormField(decoration: const InputDecoration(disabledBorder: InputBorder.none),)),
                        const Padding(
                    ...
                    Padding(
                      ...
                      child: GestureDetector(onTap: (){},child: Container(width: MediaQuery.of(context).size.width*0.9, decoration: BoxDecoration(color: Colors.black, borderRadius: BorderRadius.circular(10)),child: const Padding(
