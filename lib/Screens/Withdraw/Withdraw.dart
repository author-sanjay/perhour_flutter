...
class _WithdrawState extends State<Withdraw> {
  ...
  final snackbar = const SnackBar(
    content: Text(
        "Withdraw request sent. Money will be credited to your account in 48 hrs"),
  );
  static String ac = "";
  @override
  ...
  void post() async {
    ...
    var res = await http.post(
        Uri.parse(
            '${api}help/withdrawll/${_WithdrawState.amount}/${_WithdrawState.method}/${_WithdrawState.name}/${_WithdrawState.ac}/${user.id}'),
        headers: headers,
        body: json);
